...
class KalturaLiveChannelService extends KalturaServiceBase
{
	 ...
	 */
	function appendRecording($entryId, $assetId, $mediaServerIndex, KalturaDataCenterContentResource $resource, $duration)
	{
		$kparams = array();
		$this->client->addParam($kparams, "entryId", $entryId);
		$this->client->addParam($kparams, "assetId", $assetId);
...
class KalturaLiveStreamService extends KalturaServiceBase
{
	 ...
	 * @return KalturaLiveStreamEntry
	 */
	function addLiveStreamPushPublishConfiguration($entryId, $protocol, $url)
	{
		$kparams = array();
		$this->client->addParam($kparams, "entryId", $entryId);
		$this->client->addParam($kparams, "protocol", $protocol);
