...
public class KalturaPushToNewsDistributionProfile extends KalturaConfigurableDistributionProfile {
    ...
    public KalturaPushToNewsDistributionProfile() {
    }

    public KalturaPushToNewsDistributionProfile(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("protocol")) {
                ...
                continue;
            } else if (nodeName.equals("ips")) {
                this.ips = ParseUtils.parseString(txt);
                continue;
                ...
                continue;
            } else if (nodeName.equals("certificateKey")) {
                this.certificateKey = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("bodyXslt")) {
                this.bodyXslt = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
