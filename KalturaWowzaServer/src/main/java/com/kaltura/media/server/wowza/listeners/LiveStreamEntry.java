...
public class LiveStreamEntry extends ModuleBase {
	...
	class LiveStreamListener extends MediaStreamActionNotifyBase implements ILiveManager.ILiveEntryReferrer {
        ...
        // Add documentation so people can understand what the hell we wrote here
        // Check with Guy this contractor. Why can't we just use the private variable in the father class?
        // Shouldn't we encapsulate appInstance? Should it be public or private?
