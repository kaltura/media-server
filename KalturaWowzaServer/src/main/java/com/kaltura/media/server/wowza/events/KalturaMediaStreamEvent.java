...
public class KalturaMediaStreamEvent extends KalturaStreamEvent {
	...
	public KalturaMediaStreamEvent(IKalturaEventType type, KalturaLiveEntry entry, KalturaEntryServerNodeType serverIndex, String applicationName, IMediaStream mediaStream) {
		super(type, entry, serverIndex, applicationName);

		this.mediaStream = mediaStream;
	}

	public KalturaMediaStreamEvent(IKalturaEventType type, KalturaLiveEntry entry, KalturaEntryServerNodeType serverIndex, String applicationName, IMediaStream mediaStream, int assetParamsId) {
