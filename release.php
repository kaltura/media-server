<?php
require_once(__DIR__ . '/build/tmp/github-php-client/GitHubClient.php');
...
$jars = glob(__DIR__ . "/build/tmp/artifacts/Kaltura*.jar");
foreach ($jars as $jar) {
    uploadAsset($client, $jar, $owner, $repo, $releaseId,'application/java-archive');
}

//upload the zip distribution
$filePath = __DIR__ . "/build/distributions/KalturaWowzaServer-install-$version.zip";
